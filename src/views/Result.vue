		...
		<div>
			<div class="px-6 md:px-0 container mx-auto my-10">
				<div>
					...
					>
						<span class="w-1/2 ml-8 pl-6"> Nazov </span>
						<span class="w-1/4 text-center">
							Percentuálna zhoda
						</span>
						<span class="w-1/4 text-center mr-4"> Počet zhôd </span>
					</div>
					<div v-for="doc in documents" :key="doc.id">
						...
						>
							...
							<div class="w-2 mr-2">
								<i class="fas fa-angle-right hover-target text-2xl text-gray-600"></i>
							</div>
						</router-link>
					</div>
				</div>
